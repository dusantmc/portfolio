...
export default function KcalsPage() {
  ...
  const [showAllCustomPills, setShowAllCustomPills] = useState(false);
  ...
  return (
    ...
    <div className={`kcals-content${inputFocused ? " is-focused" : ""}`} onClick={handleContentClick} ref={contentRef}>
        ...
        <div className="kcals-suggestions" ref={suggestionsScrollRef}>
          ...
          <div className="kcals-suggestions-content">
            ...
            <div className="kcals-suggestion-section">
              ...
              {customFoods.length > 0 && (
                <div className={`kcals-pills${!showAllCustomPills && !queryActive ? " kcals-pills--collapsed" : ""}`}>
      ...
      <BottomSheet
        ...
        onClose={() => { setShowSummaryModal(false); setSummaryRangeOpen(false); setSummarySelectOpen(false); setSummarySelected(new Set()); }}
        variant="center"
        ...
        <div className="kcals-summary-controls">
          ...
          <div className="kcals-summary-dropdown-wrap">
            <button
              ...
              type="button"
              onClick={() => { setSummaryRangeOpen((v) => !v); setSummarySelectOpen(false); }}
            >
